      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        ...
        >
          <div className="glass rounded-2xl p-8 gradient-border text-center">
            ...
            <Link
              href="/login"
              className="mt-6 inline-flex items-center text-primary hover:text-primary/80 text-sm font-medium transition-colors"
            >
              Voltar ao login
            </Link>
          </div>
        ...
        <div className="glass rounded-2xl p-8 gradient-border">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Workspace inteligente</p>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-foreground mb-1">Criar conta</h2>
          <p className="text-muted-foreground mb-8 text-sm">
            Comece seu workspace inteligente agora
          </p>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={cn(
                    "w-full px-4 py-3 pr-12 rounded-xl bg-muted border border-border",
                    "text-foreground placeholder:text-muted-foreground",
                    "focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50",
                    "transition-all duration-200 text-sm"
                  )}
